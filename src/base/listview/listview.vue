...
const ANCHOR_HEIGHT = 18 // 字体 + padding
const TITLE_HEIGHT = 30

export default {
  created() {
    // 没必要在data初始化，因为不需要监听touch
    this.touch = {}
  ...
  methods: {
    ...
    _scrollTo(index) {
      ...
      this.$refs.listview.scrollToElement(this.$refs.listGroup[index], 0) // 0代表动画 不要
    },
    _calculateHeight() {
      this.listHeight = []
